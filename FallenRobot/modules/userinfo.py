...
def info(update: Update, context: CallbackContext):
    ...
    if user_id not in [bot.id, 777000, 1225278379]:
            ...
            message.reply_photo(
                ...
                reply_markup=InlineKeyboardMarkup(
                    [
                        [
                            InlineKeyboardButton(
                                "ʜᴇᴀʟᴛʜ", url="https://t.me/Octave_support/24"
                            ),
                            InlineKeyboardButton(
                                "ᴅɪꜱᴀꜱᴛᴇʀ", url="https://t.me/Octave_support/26"
                            ),
                        ],
                    ]
                ),
...
def set_about_me(update: Update, context: CallbackContext):
    ...
    if user_id in [777000, 1225278379]:
    ...
    if message.reply_to_message:
        ...
        if repl_user_id in [bot.id, 777000, 1225278379] and (user_id in DEV_USERS):
...
def set_about_bio(update: Update, context: CallbackContext):
    ...
    if message.reply_to_message:
        ...
        if user_id in [777000, 1225278379] and sender_id not in DEV_USERS:
            message.reply_text("You are not authorised")
            return

        if user_id == bot.id and sender_id not in DEV_USERS:
            message.reply_text(
                "Umm... yeah, I only trust Octave Association to set my bio."
            )
            return

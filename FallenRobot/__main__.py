...
buttons = [
    ...
    [
        InlineKeyboardButton(text="🥀 My Daddy 🥀", url=f"tg://user?id={OWNER_ID}"),
        ...
        query.message.edit_text(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    [
                        InlineKeyboardButton(
                            text="sᴜᴩᴩᴏʀᴛ", callback_data="Octave_support"
                        ),
                        InlineKeyboardButton(
            ...
            reply_markup=InlineKeyboardMarkup(
                [
                    ...
                    [
                        ...
                        InlineKeyboardButton(
                            text="ɢɪᴛʜᴜʙ",
                            url="https://te.legra.ph/file/098422ced35d8802b27b6.jpg",
                        ),
                    ],
                    [
...
*ʜᴇʀᴇ ɪs ᴍʏ sᴏᴜʀᴄᴇ ᴄᴏᴅᴇ :* [ɢɪᴛʜᴜʙ](https://te.legra.ph/file/098422ced35d8802b27b6.jpg)


{BOT_NAME} ɪs ʟɪᴄᴇɴsᴇᴅ ᴜɴᴅᴇʀ ᴛʜᴇ [ᴍɪᴛ ʟɪᴄᴇɴsᴇ](https://te.legra.ph/file/098422ced35d8802b27b6.jpg).
